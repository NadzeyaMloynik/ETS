...
class UserService {
  ...
  static async getAllUsersPagination(pageNo, token) {
    try {
      const response = await axios.get(
        `${UserService.BASE_URL}/admin/users/pagination`,
        {
          params: { pageNo },
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  static async getAllUsersPaginationNameLastname(pageNo, keyword, token) {
    try {
      const response = await axios.get(
        `${UserService.BASE_URL}/hr/search-users/pagination`,
        {
  ...
  static async getUserImage(userId, token) {
    try {
      const response = await axios.get(
        `${UserService.BASE_URL}/adminuser/${userId}/photo`,
        {
          headers: { Authorization: `Bearer ${token}` },
  ...
  static async updateUserPhoto(userId, photoFile, token) {
    try {
      ...
      const response = await axios.put(
        `${UserService.BASE_URL}/adminuser/${userId}/upload-photo`,
        formData,
        {
          headers: {
